...
class Hyd:
    @classmethod
    def acceptobjdata(cls,obj,objinfo):
...
Hyd.acceptobjdata(s,"Student")# Class Level method accessed w.r.t Class Name
Hyd.acceptobjdata(e,"Employee") # Class Level method accessed w.r.t Class Name
Hyd.acceptobjdata(t,"Teacher")# Class Level method accessed w.r.t Class Name